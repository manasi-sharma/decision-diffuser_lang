...
class Trainer(object):
    def __init__(
        ...
        cfg_task_dataset = {'_target_': 'code.diffuser.datasets.diffusionpolicy_datasets.kitchen_mjl_lowdim_dataset.KitchenMjlLowdimDataset', 'abs_action': True, 'dataset_dir': 'data/kitchen/kitchen_demos_multitask', 'horizon': 16, 'pad_after': 7, 'pad_before': 1, 'robot_noise_ratio': 0.1, 'seed': 42, 'val_ratio': 0.02}
